...
const RESIDENTIAL_PLANS: Plan[] = [
  {
    ...
    price: 100,
    period: "month",
    description: "Low cost areas",
    color: "#6B7280",
    features: [
      { text: "2 pickups per month", included: true },
  ...
  },
  {
    ...
    price: 200,
    period: "month",
    description: "Best value for medium cost areas",
    color: "#22C55E",
    popular: true,
    features: [
  ...
  },
  {
    ...
    price: 300,
    period: "month",
    description: "Premium experience for high cost areas",
    color: "#F59E0B",
    features: [
      { text: "8 pickups per month", included: true },
...
const COMMERCIAL_PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "1 refuse bin liner", included: true },
  ...
  },
  {
    ...
    features: [
      { text: "8 pickups per month", included: true },
      { text: "2 pickups per week", included: true },
      { text: "Weekly reports", included: true },
      { text: "Priority support", included: true },
      { text: "Large waste capacity", included: true },
      { text: "Custom schedule", included: false },
    ],
  },
  {
    ...
    color: "#F59E0B",
    features: [
      { text: "12 pickups per month", included: true },
